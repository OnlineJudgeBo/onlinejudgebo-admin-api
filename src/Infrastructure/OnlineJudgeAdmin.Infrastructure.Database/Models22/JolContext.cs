...
public partial class JolContext : DbContext
{
    public JolContext()
    {
    }

    public JolContext(DbContextOptions<JolContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<Compileinfo> Compileinfos { get; set; }
    ...
    public virtual DbSet<Runtimeinfo> Runtimeinfos { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=172.19.0.2;database=jol;user=root;pwd=root", Microsoft.EntityFrameworkCore.ServerVersion.Parse("11.2.2-mariadb"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Compileinfo>(entity =>
        {
            ...
            entity.HasOne(d => d.Solution).WithOne(p => p.Compileinfo)
                .HasForeignKey<Compileinfo>(d => d.SolutionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Problem>(entity =>
        {
            ...
            entity.HasMany(d => d.Classifications).WithMany(p => p.Problems)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<Classification>().WithMany()
        ...
        modelBuilder.Entity<Runtimeinfo>(entity =>
        {
            ...
            entity.HasOne(d => d.Solution).WithOne(p => p.Runtimeinfo)
                .HasForeignKey<Runtimeinfo>(d => d.SolutionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Sim>(entity =>
        {
            ...
            entity.Property(e => e.SId)
                ...
                .HasColumnType("int(11)")
                .HasColumnName("s_id");
            entity.Property(e => e.Sim1)
                .HasColumnType("int(11)")
                .HasColumnName("sim");
            entity.Property(e => e.SimSId)
                .HasColumnType("int(11)")
                .HasColumnName("sim_s_id");
        });
        ...
        modelBuilder.Entity<SourceCode>(entity =>
        {
            ...
            entity.HasOne(d => d.Solution).WithOne(p => p.SourceCode)
                .HasForeignKey<SourceCode>(d => d.SolutionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<UserActivity>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithOne(p => p.UserActivity)
                .HasForeignKey<UserActivity>(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
